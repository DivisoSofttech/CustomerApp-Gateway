...
import com.diviso.graeshoppe.customerappgateway.client.payment.model.RefundResponse;
...
public interface BraintreeCommandResourceApi {
    ...
    ResponseEntity<RefundResponse> createRefundUsingPOST(@ApiParam(value = "amount",required=true) @PathVariable("amount") Double amount,@ApiParam(value = "transactionId",required=true) @PathVariable("transactionId") String transactionId);
