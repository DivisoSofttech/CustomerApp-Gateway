...
public class StatusDTO   {
  ...
  public StatusDTO description(String description) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.description, statusDTO.description) &&
        Objects.equals(this.id, statusDTO.id) &&
        Objects.equals(this.name, statusDTO.name) &&
        Objects.equals(this.reference, statusDTO.reference);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, name, reference);
  }
