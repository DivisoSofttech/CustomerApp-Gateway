...
public interface OrderLineResourceApi {
    ...
    @RequestMapping(value = "/api/orders-lines",
        produces = "*/*", 
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<OrderLineDTO> createOrderLineUsingPOST(@ApiParam(value = "orderDTO" ,required=true )  @Valid @RequestBody OrderLineDTO orderLineDTO);
