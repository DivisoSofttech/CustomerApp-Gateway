...
public interface PaymentCommandResourceApi {
    ...
    @ApiOperation(value = "createPayment", nickname = "createPaymentUsingPOST", notes = "", response = PaymentDTO.class, tags={ "payment-command-resource", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<PaymentDTO> createPaymentUsingPOST(@ApiParam(value = "paymentDTO" ,required=true )  @Valid @RequestBody OrderPaymentDTO paymentDTO);
    ...
    @ApiOperation(value = "getAllPayments", nickname = "getAllPaymentsUsingGET", notes = "", response = PaymentDTO.class, responseContainer = "List", tags={ "payment-command-resource", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "getPayment", nickname = "getPaymentUsingGET", notes = "", response = PaymentDTO.class, tags={ "payment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = PaymentDTO.class),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
    ...
    @ApiOperation(value = "updatePayment", nickname = "updatePaymentUsingPUT", notes = "", response = PaymentDTO.class, tags={ "payment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = PaymentDTO.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
